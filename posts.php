<?php theme_include('header'); ?>
  ...
  <div class="sub-footer">
    <p class="meta wrap post">&copy; <?php echo date('Y'); ?> <a href="<?php echo full_url(); ?>"><?php echo site_name(); ?></a> | <a href="http://www.themadones.co/about">About</a> | <a href="http://www.themadones.co/contact">Contact</a></p>
  </div>
